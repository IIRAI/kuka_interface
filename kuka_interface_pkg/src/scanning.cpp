...
int main(int argc, char **argv)
{
	...
	std::cout<<"1: right scanning position"<<std::endl;
	...
	//Exp 1,2,3
	// scanning position
 	homing_right.push_back(1.1508);   //a1
 	homing_right.push_back(-1.9297);  //a2
 	homing_right.push_back(-0.2164);  //e1
 	homing_right.push_back(-0.7133);  //a3
	homing_right.push_back(0.1182);   //a4
 	homing_right.push_back(1.8383);   //a5
 	homing_right.push_back(-2.1925);  //a6
