...
if strcmp(cmd, 'I')
    ...
    switch cmd(2)
        case '0' % homing
            ...
            set_param(sim_name + '/hand_synergy', 'Value', sprintf('%f', 0));  % open hand command I6
            set_param(sim_name + '/velvet_ctrl',  'Value', sprintf('%f', 1));  % unroll elvet tray
