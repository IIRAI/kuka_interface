...
qd_local_left  = spline_traj_left( t_prova(1,1), q_init_left,  pose_left(1:3),  pose_left(4:6),  t_prova(1,1));
qd_local_right = spline_traj_right(t_prova(1,2), q_init_right, pose_right(1:3), pose_right(4:6), t_prova(1,2));
