...
% ----------------------------------------------------------------------- %
% REMARK:
%   This function is thought to be called from a simulink model (iliad_test.slx)
%   and after running the initialization script (init_iliad_test.m)
% ----------------------------------------------------------------------- %
...
qd_local_left  = spline_traj_left( t_prova(1,2),  q_init_left,...
                                   pos_home_left,  rot_home_left,...
                                   t_prova(1,2));
qd_local_right = spline_traj_right(t_prova(1,1), q_init_right,...
                                   pos_home_right, rot_home_right,... 
                                   t_prova(1,1));

% OUTPUT: normalize trajectory to `max_output_length`
qd_home_left  = zeros(7,max_output_len);
qd_home_right = zeros(7,max_output_len);
